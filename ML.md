...
Так вот перцептрон это частный случай, когда эти несколько моделируемых функций пологаю 3 (которые и дают нам знаменитые OR, XOR, AND), имеют такие значения что результатом является логическая операция над исходными точками этих функций.
