...
Что мы имеем, мы имеем корни, 1,2,3 это величины качества, в милиардных единицах.

Имеем для 2009 года:

Корень 3 покупателям Android стоил -356.156502 млрд, единиц качеств.

Корень 2 специалистам Android стоил -2811.595018 млрд, единиц качеств.

Корень 1 мечтающим получить телефон Android стоил -17.26122, единиц качеств.

Если базовая оценка, качеств пологает что $y_1=-3$ - теряется отцовство, $y_2=-0.5$ - материнская любовь, $y_3=-2.5$ - ребячество. 
 
Так необходимо вычислить семейный капитал. Необходимо понимать что качества приобретаются с помощью продуктов.
