...
А что если представить функцию Y = X * w что мы получим ? w - некоторая случайная величина, просто величина которая не позволяет быть функции прямой, т.е нести прямопорпорциональную зависимость. Сколько отработал - Столько и получил (пример редакции).

Допустим w это некоторая случайная величина которую мы будем исследовать, что бы составить ее закон - внести в протокол заседания нашего научного соощества формулу функции.
