...
Корни: $x_1=-3$ - папа, $x_2=-0.5$ - мама, $x_3=-2.5$ - ребенок. Есть наименьшие значения при которых моделируемая функция показывает жизнь. Тогда пологаю что изменение весов при обучении на заданную величину за один шаг и *убивает* или папу, или маму, или ребенка.
