...
### Закон сохранения Силы,Формы,Энергии [0](../ocs/Библиотека/Модель.Вселенной.md)
...
**Оружие** - на базе этих наработок можно создать оружие работающие на совершенно других принципах, на принципах микро-макро космологических взаимосвязей. Автором является никто иной как [Фрэнк Розенблат](http://ru.wikipedia.org/wiki/Розенблатт,%20Фрэнк) который наверняка знает о побочных эфектах предложенной им эксперементальной модели мозга (ранее это был рисунок болота, достаточно было его нарисовать и опбулчить порцию энергии) концепция бога и богоизбранности держится именно на этом, на том что избыток постоянно гуляет и получает его тот кто может систематизировать его. К слову лицензия на его разработки звучит так - только если докажите ее безопасность - ее - новой модели нейросети.
