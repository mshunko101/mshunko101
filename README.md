...
Примем за исходное RGB представление света, который на протяжении бесконечности может быть замедляется, то есть теряет силу и энергию и начинает менять форму.
