...
Корни: $x_1=-3$ - папа, $x_2=-0.5$ - мама, $x_3=-2.5$ - ребенок. Данная ситуация описывает счасливый семейный уклад. (Думаю что отрицательные значения это страх, обеспокоенность к окружающей среде)
