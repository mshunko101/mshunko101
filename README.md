...
[Модель вселенной](Модель.Вселенной.md) => [Хроника (километры)](Хроника%20забытых%20сознаний.md) => [Исток](univers.metaphor.png) - можно сделать вывод, что образы истока (силы - мужская рука +, женсткое -, формы - солнце или шары+ , безформенная жижа -, энергии - краснота+ , зеленота -) есть сигнал - *быть готовым*, то есть так задается новая вводная для жителей вселенной. Восприятие в реальном времени, т.е *на лету* этих сигналов гарантирует спокойствие и только спокойствие, жизнь, радость и счастье.
