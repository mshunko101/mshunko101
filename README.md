...
[Модель вселенной](Модель.Вселенной.md) => [Хроника (километры)](Хроника%20забытых%20сознаний.md) => [Исток](univers.metaphor.png) - можно сделать вывод, что образы истока (силы - мужская рука, формы - солнце или шары, энергии - краснота) есть сигнал - *быть готовым*, то есть так задается новая вводная для жителей вселенной. 
