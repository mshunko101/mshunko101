...
Условие появления ребенка $\LARGE x_3$ на свет , папа должен пожертвовать собой $\LARGE\frac{1}{2}x_1$ - отдать частичку себя, мама должна быть готова стать мамой $\LARGE 2x_2$<br>

$\LARGE\frac{1}{2}x_1+2x_2=x_3$

Взросление ребенка, папа обязан обеспечить защиту для мамы и ребенка.

$\LARGE\frac{x_1}{x_2+x_3}=1$

Самостоятельность ребенка, когда он без родителей может управится, справится с ежедневными делами и при этом не потерять себя.
