...
Она необходима для построения модели вычислений проекта [**Сервис сохранения**](https://github.com/mshunko101/mind_preservation_service).
...
Всем ученым которые ищут корни и никак не могут найти заявляю (в той же манере интонации и содержании):
