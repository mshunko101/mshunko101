...
Что если система не имеет решения с заданными коэфициентами? - ... наверно это разрушения окружающей обстановки и поиск корней для решения если их не удается найти дальнейшая смерть.
