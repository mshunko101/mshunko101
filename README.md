...
ВЕРДИКТ - ЭТО НЕВОЗМОЖНО! (обозначает что переработанный информационный поток который склонял меня к дейсвтию ирационален, следуя модели [порождения](./Библиотека/МОДЕЛЬ.ПОРОЖДЕНИЯ.md) я говорю НЕТ )
<br>
<br>
<br>
